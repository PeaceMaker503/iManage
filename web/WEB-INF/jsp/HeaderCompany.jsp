        ...
        <nav class="navbar navbar-inverse" style="margin-bottom: 0px;">
           <div class="container-fluid">
                ...
                <li id="search"><a href="<%=request.getContextPath()+"/Search?login=" + request.getParameter("login")%>" style="font-weight:bold;"><span class="glyphicon glyphicon-search"></span> Search</a></li>
						...
						<li id="candidatures"><a href="<%=request.getContextPath()+"/Candidatures?login=" + request.getParameter("login")%>" style="font-weight: bold;"><span class="glyphicon glyphicon-inbox"></span> My Offers</a></li>
                        </ul>
