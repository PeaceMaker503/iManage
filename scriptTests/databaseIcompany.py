...
if __name__ == '__main__':
	...
	listOfinternships = [("prototype projet qui ne sert a rien","/home/appCritique.pdf","entreprise a taille humaine cherche petit stagiaire",idInfo),\
						("developpement Amazon web services","/home/webServiveces","expert SOA qui doit travailler dur",idInfo),\
						("developpement Objet connecte","/home/iot.pdf","prototype toilettes connectees",idInfo),\
						('amelioration process enzyme de la life',"/home/enzyme.pdf","amelioration process developpement enzyme de la life",idBio)]
